const Skills = [
    ...
    { type: 'framwork', label: 'Spring MVC', percentage: 80 },
    { type: 'framwork', label: 'Spring ', percentage: 85 },
    { type: 'framwork', label: 'Spring data jpa', percentage: 85 },
    { type: 'framwork', label: 'NodeJS', percentage: 80 },

    { type: 'framwork', label: 'Angular', percentage: 75 },
    { type: 'framwork', label: 'Bootstrap', percentage: 80 },
